...
- Crie um projeto react com create-vite: `npm init --yes vite@latest homeexpenses.client -- --template=react-ts`.
...
- Criar o arquivo de projeto (`homeexpenses.client.esproj`).
